...
\033[1;91m [⚡\033[1;97mAuthor Name: MD ARIF HOSSEN     ⚡\033[1;91m]
\033[1;91m [⚡\033[1;97mYutube Chnl: MD ARIF HOSSEN ⚡\033[1;91m]
\033[1;91m [⚡       \033[1;97mFrom: Bangladesh      ⚡\033[1;91m]
\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mMD ARIF\033[1;95m-_-_-_-_-_-_-_-_-»
"""
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "Logged in successfully as " + username #MD_ARIF
	    time.sleep(2)
            loop = 'false'
        else:
...
def menu():
	...
	print "\033[1;97m[3]\x1b[1;92mFollow My Facebook account " 
...
def pilih_super():
	...
	if peak =="":
		...
		os.system('clear')
		print "\033[1;95m«-_-_-_-_-_-_-_-_-\033[1;91mMD ARIF\033[1;95m-_-_-_-_-_-_-_-_-»"
		print logo
